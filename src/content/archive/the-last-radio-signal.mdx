...
description: >-
  Astronomers detect a repeating signal from deep space. After forty-three years
  of decoding, the message contains four words: Don't build the AI.
summary: >-
  The signal wasn't frightening because of what it said. It was frightening
  because seventeen civilizations recognized it.
published: true
date: '2026-06-28'
...
pullQuote: >-
  Every civilization believes it is receiving the warning. None realize they are
  already preparing to send it.
...
<BigQuote>The signal had been traveling toward Earth for 42,183 years.</BigQuote>
...
<BigQuote>The shortest message in human history became the longest debate.</BigQuote>
...
<BigQuote>A warning without context becomes whatever people fear most.</BigQuote>
...
<BigQuote>They told us not to build it. Then they sent us theirs.</BigQuote>
...
<BigQuote>The oldest discoveries aren't always buried. Sometimes... they're waiting.</BigQuote>
