...
<Image
  ...
  alt="AI-generated architects discussing a blueprint"
  width={1200}
  height={700}
...
<Image
  ...
  alt="Futuristic command center with holographic data displays"
  width={1200}
  height={700}
...
<Image
  ...
  alt="Engineers viewing CAD designs on a laptop"
  width={1200}
  height={700}
  className="rounded-xl my-8 shadow-lg"
/>
...
<Image
  ...
  alt="Business team collaborating around futuristic data visualizations"
  width={1200}
  height={700}
  className="rounded-xl my-8 shadow-lg"
/>
...
<div className="flex justify-between">
  <Link href="/archive/episode-5-human-bottleneck">
