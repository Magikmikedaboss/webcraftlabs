...
```
(Base Build × Design Depth)
  + Content
  + Functionality
  + Integrations
  + Required Page Expansion
  + QA / Performance
  + Timeline Adjustment
  ─────────────────────────
  = Project Estimate
...
The important part is the **parentheses**. Design depth isn't a line item added at the end — it multiplies the work underneath it. A custom design means every page, component and state is drawn and built for you rather than filled in, so it scales with how much site there is.
...
The same company adds member logins, a payment flow, and a rushed deadline.

- **Tier:** Full Site (at the ceiling) · **Pages:** 10
- **Estimate: $14,732 – $18,824** · roughly 131 hours · 3–5 weeks

**Why it lands there:** membership means authentication and protected areas; payments mean a checkout flow and confirmations; rush timing adds a quarter across everything.
