...
summary: "An underground archive was discovered. The shelves showed decades of use. Nothing remained."
...
<HandSketch title="Field Sketch — Chamber Layout (Day 18)">

```
┌─────────────────────────────────────┐
│  ← Eastern Wall  (Inscription)      │
│                                     │
...
│  [ ░░░ ] │ [ ░░░ ] │ [ ░░░ ]       │
│                                     │
│  Environmental Controls  →  [  ?  ] │  ← Still running. Source unknown.
└─────────────────────────────────────┘
```

All 128 shelf positions confirmed empty at time of recovery.
...
<MarginNote author="Meridian Review">

Calling this an empty archive assumes it was built to preserve objects.

That assumption has not been demonstrated.
