...
description: "A Future Fiction archive file about the first message humanity receives from another civilization, and the warning hidden inside it."
summary: "Astronomers detect a signal from deep space. After decades of decoding, the message contains four words: Don't build the AI."
...
This document is a work of speculative fiction.

Not a prediction.

Not a claim.

A thought experiment recovered from the edge of tomorrow.
</LabNote>
...
The Builder answered immediately.

> **No civilization has ever found the beginning.**
...
|-------|-------|
| File | 0002 |
| Classification | Future Fiction |
| Integrity | 96.2% |
| Missing Records | 18 |
| Origin | Unknown |
| Earliest Archive | Not Found |
| Next File | **PROJECT GENESIS** |
...
Connection to Project Genesis:

Confirmed.

Further access requires Level 05 clearance.
