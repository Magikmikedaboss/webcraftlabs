...
export function BigQuote({ children }: { children: React.ReactNode }) {
  return (
    <aside className="not-prose mx-auto my-16 max-w-4xl px-2 text-center sm:my-24 sm:px-4">
      <div className="text-3xl font-black leading-tight tracking-tight text-slate-950 sm:text-5xl lg:text-6xl">
